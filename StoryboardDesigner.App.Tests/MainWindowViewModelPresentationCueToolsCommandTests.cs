...
public sealed class MainWindowViewModelPresentationCueToolsCommandTests
{
    [Fact]
    public void EditObjectBasicProperties_WhenObjectOverridesAreBlank_PrefillsFromProjectDefaultsAndSavesObjectValues_PresentationCueFile()
    {
