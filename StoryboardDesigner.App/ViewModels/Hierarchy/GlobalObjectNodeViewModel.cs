...
public sealed class GlobalObjectNodeViewModel : HierarchyNodeViewModel
{
    public GlobalObjectNodeViewModel(GameObject interactiveObject, GlobalObjectsNodeViewModel parent)
        : base(interactiveObject.Name, parent)
    {
        GameObject = interactiveObject;
        ParentGlobalObjectsNode = parent;
    ...
    public GlobalObjectNodeViewModel(GameObject interactiveObject, GlobalObjectNodeViewModel parent)
        : base(interactiveObject.Name, parent)
    {
        GameObject = interactiveObject;
        ParentGlobalObjectsNode = parent.ParentGlobalObjectsNode;
    ...
    public GlobalObjectsNodeViewModel ParentGlobalObjectsNode { get; }
    public GlobalObjectNodeViewModel? ParentObjectNode { get; }
